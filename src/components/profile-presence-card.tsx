...
import PresenceHeader from '@/components/ui/presence-header'
import PresenceIdentity from '@/components/ui/presence-identity'
import ActivityCarousel from '@/components/ui/activity-carousel'
import { normalizeSpotify, type CarouselItem } from '@/components/ui/activity-row'
