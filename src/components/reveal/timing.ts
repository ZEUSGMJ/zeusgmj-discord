...
export const PROFILE_COMPACT_TRANSITION = { type: 'spring' as const, duration: 0.28, bounce: 0.1 }
export const PROFILE_SETTLE_TRANSITION = { type: 'spring' as const, duration: DUR_PROFILE_SETTLE, bounce: 0.12 }
...
export const FOOTER_COLLAPSE_PRELUDE_DELAY = DUR_FOOTER_WORDMARK_EXIT + DUR_FOOTER_MOUNTAIN_EXIT
...
export const CARD_WAVES: Record<'column' | 'tracks' | 'games' | 'media', CardWave> = {
...
export const MOBILE_CARD_WAVES: Record<'column' | 'tracks' | 'games' | 'media', CardWave> = {
